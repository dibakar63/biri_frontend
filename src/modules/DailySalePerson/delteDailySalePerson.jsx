...
const DeleteDailySalePersonModel = ({ isOpen, onClose, onSave, market,marketData,id,setId }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4" role="dialog" aria-modal="true">
      ...
      <div className="flex justify-between items-center mb-4">
        <span className="text-2xl text-center font-semibold mb-2">Delete DailySalePerson Data?</span>
        </div>
...
export default DeleteDailySalePersonModel;
