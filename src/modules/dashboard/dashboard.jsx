    ...
    <div className="w-full h-full bg-[#DDDCDC] p-10">
        ...
        <div className="sm:col-span-3 bg-[#F2F1F1] rounded-md shadow-lg p-10">
         ...
         <div className="sm:col-span-3 bg-[#F2F1F1] rounded-md shadow-lg p-10">
          ...
          <thead className="bg-indigo-600 text-white">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold">Total Paid</th>
              <th className="px-6 py-3 text-left text-sm font-semibold">Total Due</th>
              <th className="px-6 py-3 text-left text-sm font-semibold">Product Sales</th>
          ...
          <tbody className="divide-y divide-gray-100">
              ...
              <tr  className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm text-gray-900">{marketReport.market}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{marketReport.totalPaid}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{marketReport.totalDue}</td>
          ...
          <tbody className="divide-y divide-gray-100">
            {marketReport?.productSales?.map((market, index) => (
              <tr key={index} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm text-gray-900">{market.productCode}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{market.quantity}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{market.unit}</td>
         ...
         <div className="sm:col-span-2 bg-[#F2F1F1] rounded-md shadow-lg p-10">
            <Chart options={options} labels={options.labels} series={options.series} type="donut" width="380" height={250} />
        </div>
